...
func TestMatchmaker_AddRemovePlayer(t *testing.T) {
	...
	require.NoError(t, mm.AddPlayer(client, "classic", false, 10*time.Minute))
...
func TestMatchmaker_AddPlayer_UnknownMode(t *testing.T) {
	...
	err := mm.AddPlayer(client, "unknown", false, 10*time.Minute)
	require.Error(t, err)
...
func TestMatchmaker_CasualMatch(t *testing.T) {
	...
	require.NoError(t, mm.AddPlayer(c1, "classic", false, 10*time.Minute))
	require.NoError(t, mm.AddPlayer(c2, "classic", false, 10*time.Minute))
...
func TestMatchmaker_RankedMatch_Success(t *testing.T) {
	...
	require.NoError(t, mm.AddPlayer(c1, "classic", true, 10*time.Minute))
	require.NoError(t, mm.AddPlayer(c2, "classic", true, 10*time.Minute))
