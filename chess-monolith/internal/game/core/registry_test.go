...
func (m *MockMode) ValidateMove(b *Board, turn Color, f, t Pos) error { return nil }
func (m *MockMode) ApplyMoveSideEffects(b *Board, f, t Pos)           {}
func (m *MockMode) CheckState(b *Board, turn Color) string            { return "" }
